...
func (this *MySqlDataOperator) QueryMap(tableId string, start int64, limit int64, includeTotal bool, context map[string]interface{}) ([]map[string]string, int64, error) {
	ret := make([]map[string]string, 0)
	db, err := this.GetConn()
...
func (this *MySqlDataOperator) QueryArray(tableId string, start int64, limit int64, includeTotal bool, context map[string]interface{}) ([]string, [][]string, int64, error) {
	db, err := this.GetConn()
...
func (this *MySqlDataOperator) Exec(tableId string, context map[string]interface{}) (int64, error) {
	db, err := this.GetConn()
