...
type DataOperator interface {
	...
	ExecMap(resourceId string, params [][]interface{}, queryParams map[string]string, context map[string]interface{}) ([][]map[string]string, error)
	ExecArray(resourceId string, params [][]interface{}, queryParams map[string]string, context map[string]interface{}) ([][][]string, error)
