...
type DataOperator interface {
	...
	QueryMap(resourceId string, params []string, context map[string]interface{}) ([]map[string]string, error)
	QueryArray(resourceId string, params []string, context map[string]interface{}) ([]string, [][]string, error)
	Exec(resourceId string, params []string, context map[string]interface{}) (int64, error)
